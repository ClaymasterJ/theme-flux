...
export default {
    ...
    misc: {
      ...
      properties: {
        refreshTimeMinutes: {
          ...
          description: "How often, in minutes, will the package check what time of day it is.",
          minimum: 0,
          default: 15
        }
      }
  ...
  async activate() {
    ...
    this.intervalId = setInterval(
      this.checkUpdateTheme.bind(this),
      this.getMillisecondsFromMinutes(
        atom.config.get("theme-fluxor.misc.refreshTimeMinutes")
      )
    );
  },
